...
End-to-end smoke tests run against the real API to validate critical flows (devboxes, snapshots, blueprints, agents, executions/log tailing) and verify custom helpers like `poll()` are importable.
