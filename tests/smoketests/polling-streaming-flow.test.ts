/**
 * E2E coverage for the streaming reconnect helpers against the live API.
 * AbortSignal handling for poll() is covered by unit tests in tests/polling.test.ts.
 */
...
(process.env['RUN_SMOKETESTS'] ? describe : describe.skip)('smoketest: streaming flows', () => {
  test.concurrent(
