...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['input_context', 'name', 'scoring_contract'],
    $defs: {
      input_context: {
        type: 'object',
        description:
      ...
      scoring_contract: {
        ...
        required: ['scoring_function_parameters'],
      },
      scoring_function: {
        type: 'object',
...
export const handler = async (client: Runloop, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.scenarios.create(body));
};
