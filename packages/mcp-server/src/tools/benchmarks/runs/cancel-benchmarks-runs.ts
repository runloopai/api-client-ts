...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/benchmarks/runs/{id}/cancel',
  operationId: 'cancelBenchmarkRun',
};

export const tool: Tool = {
  name: 'cancel_benchmarks_runs',
  description:
...
export const handler = async (client: Runloop, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.benchmarks.runs.cancel(id)));
};
