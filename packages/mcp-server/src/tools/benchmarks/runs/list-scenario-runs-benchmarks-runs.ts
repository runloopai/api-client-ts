  ...
  inputSchema: {
    ...
    properties: {
      ...
      state: {
        ...
        enum: ['running', 'scoring', 'scored', 'completed', 'canceled', 'timeout', 'failed'],
      },
      jq_filter: {
        type: 'string',
        title: 'jq Filter',
...
export const handler = async (client: Runloop, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.benchmarks.runs.listScenarioRuns(id, body).asResponse();
