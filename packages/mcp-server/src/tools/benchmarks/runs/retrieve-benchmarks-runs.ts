...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/benchmarks/runs/{id}',
  operationId: 'getBenchmarkRun',
};

export const tool: Tool = {
  name: 'retrieve_benchmarks_runs',
  description:
...
export const handler = async (client: Runloop, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.benchmarks.runs.retrieve(id)));
};
