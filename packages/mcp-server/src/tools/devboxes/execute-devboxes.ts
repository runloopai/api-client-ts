...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      command_id: {
        type: 'string',
        description: 'The command ID for idempotency and tracking',
      },
      shell_name: {
        type: 'string',
        description:
    ...
    required: ['id', 'command', 'command_id'],
  },
  annotations: {},
};
...
export const handler = async (client: Runloop, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.devboxes.execute(id, body)));
};
