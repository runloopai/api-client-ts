...
export const tool: Tool = {
  name: 'retrieve_devboxes_executions',
  description:
  ...
  inputSchema: {
    ...
    properties: {
      ...
      last_n: {
        type: 'string',
        description: 'Last n lines of standard error / standard out to return',
      },
      jq_filter: {
        type: 'string',
        title: 'jq Filter',
...
export const handler = async (client: Runloop, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.devboxes.executions.retrieve(devbox_id, execution_id, body)),
  );
};
